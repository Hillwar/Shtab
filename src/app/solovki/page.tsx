        ...
        <div className="grid gap-8 md:grid-cols-2 mt-12">
          ...
          <Card className="p-8">
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li>• Волонтерскую деятельность</li>
            </ul>
          </Card>
        </div>
            ...
            <div className="max-w-3xl">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-white/80">
                  Уникальная возможность изучить историю, культуру и природу Соловецкого архипелага и внести свой вклад в благоустройство и состояние базы музея-заповедника
                </p>
              </motion.div>
            </div>
          </div>
